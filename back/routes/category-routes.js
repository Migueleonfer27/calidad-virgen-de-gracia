...
router.post('/insert',[check('name', 'El nombre es obligatorio').not().isEmpty(),
 ...
 ], validateJWT,isRolValid(abilities.createCategory),categoryController.insert)
router.delete('/delete/:id', validateJWT,isRolValid(abilities.deleteCategory),categoryController.delete)
router.put('/update', validateJWT,isRolValid(abilities.updateCategory),categoryController.update)
