...
router.put(
  "/updateState",
  validateJWT,
  isRolValid(abilities.updateStateTask),
  isMyTask,
...
router.delete(
  "/deleteFromUser",
  validateJWT,
  isRolValid(abilities.deleteMyTask),
  isMyTask,
  taskController.deleteFromUser
);

router.delete(
  "/delete/:id",
  validateJWT,
  isRolValid(abilities.deleteTask),
...
router.post(
  ...
  [
    ...
    check("id_document[0]", "Debe ser asignado algún documento")
      .not()
      .isEmpty(),
    validarCampos,
  ],
  validateJWT,
  isRolValid(abilities.createTask),
...
router.get(
  "/getById/:id",
  validateJWT,
  isRolValid(abilities.getMyTask),
  isMyTask,
  taskController.getByIdUser
);

router.get(
  "/",
  validateJWT,
  isRolValid(abilities.getTasks),
...
router.put(
  ...
  validateJWT,
  isRolValid(abilities.updateTask),
