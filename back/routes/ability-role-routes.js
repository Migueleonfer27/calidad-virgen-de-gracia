...
router.post(
    ...
    validateJWT,isRolValid(abilities.addAbilities),
...
router.get(
    "/",
    abilitiesController.getAllAbilities
);
...
router.get(
    ...
    validateJWT,isRolValid(abilities.getAbilitiesByRol),
...
router.get(
    ...
    validateJWT,isRolValid(abilities.getAbilitiesByUser),
